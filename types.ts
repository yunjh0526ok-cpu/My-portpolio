...
export const SERVICE_DATA: ServiceItem[] = [
  { 
    ...
    hashtags: ["#AI롤플레잉", "#맞춤형피드백", "#실전시뮬레이션", "#행동변화유도"]
  },
  { 
    id: 2, 
    title: "조직문화 솔루션", 
    ...
    iconType: "users",
    hashtags: ["#NLP감성분석", "#소통히트맵", "#심리적안전감", "#데이터기반혁신"]
  },
  { 
    id: 3, 
    title: "청렴/적극행정 골든벨", 
    ...
    iconType: "trophy",
    hashtags: ["#AI퀴즈생성", "#실시간데이터분석", "#에듀테인먼트", "#취약점진단"]
  },
  { 
    id: 4, 
    ...
    iconType: "brain",
    hashtags: ["#AI패턴분석", "#인과관계규명", "#숨겨진갈등발굴", "#정밀솔루션"]
  },
  { 
    id: 5, 
    title: "가디언 통합 보안 포털", 
    ...
    iconType: "shield",
    hashtags: ["#이상징후탐지", "#AI실시간모니터링", "#사전예방", "#리스크스코어링"]
  },
  { 
    id: 6, 
    title: "부패 및 갑질 상담소", 
    ...
    iconType: "message",
    hashtags: ["#감정분석AI", "#법률데이터기반", "#익명케어", "#신속구제"]
  },
];